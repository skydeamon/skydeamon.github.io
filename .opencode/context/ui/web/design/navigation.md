<!-- Context: ui/web/design/navigation | Priority: critical | Version: 1.1 | Updated: 2026-09-11 -->
...
1. Reference `../foundations/specificity.md` (dark mode styling patterns)
...
- `../animation-basics.md` - CSS animations and transitions
